...
namespace UW.CSE.DISC
{
	...
	public class frmAbout : System.Windows.Forms.Form
	{
		...
		public frmAbout()
		{
			...
			myName = "Windows Media Gateway";
			myVersion = "Unknown";
			myRTP = "";
			myCopyright = "";

			Assembly mainAssembly = Assembly.GetExecutingAssembly();
			//myAssemblyName = mainAssembly.FullName;
			myVersion =  mainAssembly.GetName().Version.ToString();

			AssemblyName [] ar = mainAssembly.GetReferencedAssemblies();

			foreach (AssemblyName refname in ar)
			{
				if (refname.Name == "MSR.LST.Net.RTP")
				{
					myRTP = "MSR.LST.Net.RTP v." + refname.Version.ToString();
				}
			}
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel1.Text = "www.cs.washington.edu/education/dl/disc/wmgateway.html";
			...
			this.Name = "frmAbout";
			this.Text = "About ConferenceXP to Windows Media Gateway";
